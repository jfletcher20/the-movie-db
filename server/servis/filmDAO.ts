...
export class FilmDAO {
	...
	dajNekoliko = async (brojFilmova: any, prijedlozi: any) => {
		let sql: string, podaci: any;
		switch(prijedlozi) {
			case "1":
				this.baza.spojiSeNaBazu();
	...
	dajZanroveFilma = async (film_id: any) => {
	...
	dodajKorisnik = async (film_id: any, korime: any) => {
	...
	dodajKorisnikPremaID = async (film_id: any, korisnik_id: any) => {
	...
	azuriraj = async (film: any, id: any) => {
	...
	prihvatiPrijedlogFilma = async (id: any) => {
