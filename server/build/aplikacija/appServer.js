...
//contr
const htmlUpravitelj_1 = require("./htmlUpravitelj");
const htmlUpravitelj = new htmlUpravitelj_1.HTMLUpravitelj();
const fetchUpravitelj_1 = require("./fetchUpravitelj");
const fetchUpravitelj = new fetchUpravitelj_1.FetchUpravitelj();
//host
...
async function provjeriRestServis() {
    let autorizacija = "?korime=" + konf.dajKonf()["rest.korime"] + "&lozinka=" + konf.dajKonf()["rest.lozinka"];
