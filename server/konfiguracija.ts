...
export class Konfiguracija {
    ...
    injectionValidacija(string: string) {
    ...
    korimeValidacija(korime: string) {

        if(!this.injectionValidacija(korime)) return false;
    ...
    lozinkaValidacija(lozinka: string) {

        if(!this.injectionValidacija(lozinka)) return false;
    ...
    stranicaValidacija(stranica: any) {

        if(!this.injectionValidacija(stranica)) return false;
